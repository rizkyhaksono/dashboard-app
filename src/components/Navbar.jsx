...
const Navbar = () => {
    ...
    return (
        // when the user clicks on the menu button, the menu will be displayed
        <div className="flex justify-between p-2 md:mx-6 relative">
            ...
            {/* navbar cart, chat, notification and profile */}
            <div className="flex">
                ...
                <TooltipComponent content="Profile" positions="BottomCenter">
                    <div className="flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg" onClick={() => handleClick("userProfile")}>
                        <img src={avatar} className="rounded-full w-8 h-8" alt="" />
                        <p>
                            <span className="text-gray-400 text-14">Hi, </span>
                            <span className="text-gray-400 font-bold ml-1 text-14">Rizky</span>
                        </p>
